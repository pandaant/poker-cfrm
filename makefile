...
CPP_EXCLUDE	  = $(addprefix $(OBJ_PATH),cfrm-main.o player-main.o cluster-abs-main.o)
...
all: prepare $(C_OBJ_FILES) $(CPP_OBJ_FILES) cfrm player cluster-abs
...
clean:
	rm -r -f obj cfrm player cluster-abs
	rm -f $(DEP_FILES)

.PHONY: clean all cfrm player
